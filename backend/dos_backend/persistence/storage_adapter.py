...
# Import config from dos_backend package (env-var-aware, no sys.path hack needed).
# Falls back to the same defaults as the project-root config.py when no env vars are set.
from ..config import (
...
class StorageAdapter(CSVLayer):
    ...
    def _sku_to_dict(sku: SKU) -> Dict:
        ...
        return {
            ...
            'ean': sku.ean or '',
            'ean_secondary': sku.ean_secondary or '',
            'moq': sku.moq,
            ...
            'waste_penalty_mode': sku.waste_penalty_mode or '',
            ...
            'department': sku.department or '',
            'oos_boost_percent': sku.oos_boost_percent,
            'oos_detection_mode': sku.oos_detection_mode or '',
            'oos_popup_preference': sku.oos_popup_preference or 'ask',
            'forecast_method': sku.forecast_method or '',
            'mc_distribution': sku.mc_distribution or '',
            'mc_n_simulations': sku.mc_n_simulations,
            'mc_random_seed': sku.mc_random_seed,
            'mc_output_stat': sku.mc_output_stat or '',
            'mc_output_percentile': sku.mc_output_percentile,
            'mc_horizon_mode': sku.mc_horizon_mode or '',
