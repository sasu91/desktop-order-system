...
from .domain.calendar import calculate_protection_period_days, Lane
from .forecast import fit_forecast_model, predict
from .uncertainty import calculate_safety_stock, sigma_over_horizon
...
def compute_order(
    ...
    from .domain.calendar import next_receipt_date
    ...
    if sigma_horizon_override is not None:
        ...
        from .uncertainty import estimate_demand_uncertainty
...
def compute_order_v2(
    ...
    from .domain.contracts import DemandDistribution as _DD, InventoryPosition as _IP
    ...
    from .domain.calendar import next_receipt_date as _nrd
