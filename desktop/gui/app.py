...
from dos_backend.domain.ledger import StockCalculator, validate_ean
from dos_backend.domain.models import SKU, EventType, OrderProposal, Stock, Transaction, PromoWindow
from dos_backend.domain.promo_uplift import estimate_uplift, UpliftReport
from dos_backend.workflows.order import OrderWorkflow, calculate_daily_sales_average
from dos_backend.workflows.receiving import ExceptionWorkflow
from dos_backend.workflows.receiving_v2 import ReceivingWorkflow
from dos_backend.workflows.daily_close import DailyCloseWorkflow
from dos_backend import promo_calendar
from .widgets import AutocompleteEntry
from .collapsible_frame import CollapsibleFrame
from dos_backend.utils.logging_config import setup_logging, get_logger
...
class DesktopOrderApp:
    ...
    def _calculate_kpi_all_skus(self):
        ...
        try:
            from dos_backend.analytics.kpi import (
                compute_oos_kpi,
                estimate_lost_sales,
    ...
    def _calculate_scoring_all_skus(self):
        ...
        try:
            ...
            from dos_backend.analytics.scoring import build_feature_row, score_all_skus
    ...
    def _update_order_info(self, *_):
        ...
        try:
            ...
            from dos_backend.domain.calendar import DEFAULT_CONFIG
    ...
    def _save_sku_form(self, popup, mode, sku_code, description, ean,
        ...
        from dos_backend.domain.models import DemandVariability
        try:
    ...
    def _check_sqlite_degradation(self):
        ...
        if candidates:
            ...
            if do_restore:
                try:
                    from dos_backend.db import restore_from_backup, DATABASE_PATH
                except ImportError:
                    from dos_backend.db import restore_from_backup
    ...
    def _reload_calendar(self):
        ...
        from dos_backend.domain.calendar import create_calendar_with_holidays
